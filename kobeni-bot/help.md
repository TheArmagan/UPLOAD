...
-|-|-
özelKomutEkle | Sunucunuza özel komut eklemenizi sağlar.. | `özelKomutEkle komutadı::Komut Cevabı.` Değişkenler: -etiket -isim -takmaisim `Değişken Kullanımı: sa::Aleyküm Selam, -etiket`
